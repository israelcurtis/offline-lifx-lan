...
MEMORY_RESERVATION=${MEMORY_RESERVATION:-96m}
MEMORY_LIMIT=${MEMORY_LIMIT:-160m}
PIDS_LIMIT=${PIDS_LIMIT:-64}
NODE_MAX_OLD_SPACE_SIZE=${NODE_MAX_OLD_SPACE_SIZE:-96}
MEMORY_WARNING_RSS_MB=${MEMORY_WARNING_RSS_MB:-112}
